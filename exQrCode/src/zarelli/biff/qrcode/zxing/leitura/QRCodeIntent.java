 ...
 */
package zarelli.biff.qrcode.zxing.leitura;
 ...
 *
 * <p>To integrate, create an instance of {@code QRCodeIntent} and call
 * {@link #initiateScan()} and wait for the result in your app.</p>
 *
 ...
 * download the application, if needed.</p>
 *
 ...
 *   IntentResult scanResult = QRCodeIntent.parseActivityResult(requestCode, resultCode, intent);
 *   if (scanResult != null) {
 *     // handle scan result
 *   }
 ...
 *
 * <pre>{@code
 * QRCodeIntent integrator = new QRCodeIntent(yourActivity);
 ...
 * download prompt dialog (or, use {@link #setTitleByID(int)} to set the title
 * by string resource ID.) Likewise, the prompt message, and yes/no button
 * labels can be changed.</p>
 *
 ...
 *
 * <p>Some formats are not enabled by default even when scanning with
 ...
 * names of formats to scan for explicitly, like "PDF_417", to use such
 * formats.</p>
 *
 * @author Sean Owen
 * @author Fred Lin
...
public class QRCodeIntent {
    ...
    private static final String TAG = QRCodeIntent.class.getSimpleName();
    public static final String DEFAULT_TITLE = "Instalar Barcode Scanner?";
    public static final String DEFAULT_MESSAGE =
            "Este aplicativo requer o Barcode Scanner. Gostaria de instalá-lo?";
    ...
    public QRCodeIntent(Activity activity) {
